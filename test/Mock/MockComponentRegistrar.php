...
/**
 * Interface MockComponentRegistrar
 * @package coffeephp\component-registry
 * @author Danny Damsky <dannydamsky99@gmail.com>
 * @since 2021-03-14
 */
final class MockComponentRegistrar implements ComponentRegistrarInterface
{
    /**
     * MockComponentRegistrar constructor.
    ...
    {
        $this->di->bind(stdClass::class, stdClass::class);
    }
}
